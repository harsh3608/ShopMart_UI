...
export class UserService {
  ...
  ResendOtp(model:ForgotPassword): Observable<OtpReturnResponse> {
    return this.http.post<OtpReturnResponse>(this.userBaseServerLink+'Resend-Otp', model, { headers: this.headers });
  }
